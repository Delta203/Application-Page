<div class="py-5 bg-light" >
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 p-2 border border-warning">
        <form class="" method="post" action="/?p=apply/addons/insert&art=Designer">
          ...
          <div class="form-group">
            <label>
              <b>
                <b>Welche Erfahrungen oder Referenzen hast du im Bereich des Designs?</b>
              </b>
            </label>
          ...
          <div class="form-group">
            <label>
              <b>
                <b>Warum möchtest du hier als Teammitglied im Bereich des Designs aktiv werden?</b>
              </b>
            </label>
