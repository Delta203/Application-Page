<div class="py-5 bg-light" >
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12 p-2 border border-danger">
        <form class="" method="post" action="/?p=apply/addons/insert&art=Moderator">
          ...
          <div class="form-group">
            <label>
              <b>
                <b>Welche Erfahrungen oder Referenzen hast du im Bereich der Moderation?</b>
              </b>
            </label>
          ...
          <div class="form-group">
            <label>
              <b>
                <b>Warum möchtest du hier als Teammitglied im Bereich der Moderation aktiv werden?</b>
              </b>
            </label>
